...
<header class="site-header" id="site-header"><div class="header-shell">
  ...
  <nav class="primary-nav" aria-label="Primary navigation"><a href="what-we-do.html">About Us</a><a href="retail-offer.html">For you</a><a href="business-offer.html">For business</a><a href="sustainability.html">Sustainability</a><a href="investor-relations.html">Investor relations</a><a href="career.html">Career</a></nav>
...
<div class="mobile-menu" id="mobile-menu" aria-hidden="true"><nav><a href="what-we-do.html"><span>About Us</span><span>→</span></a><a href="retail-offer.html"><span>For you</span><span>→</span></a><a href="business-offer.html"><span>For business</span><span>→</span></a><a href="sustainability.html"><span>Sustainability</span><span>→</span></a><a href="investor-relations.html"><span>Investor relations</span><span>→</span></a><a href="career.html"><span>Career</span><span>→</span></a></nav><div class="mobile-utility"><button type="button" data-panel-open="group-panel">ORLEN Group</button><a href="report-question-or-complaint.html">Contact</a><a href="#" data-language-toggle data-language="pl">Polski</a></div></div>
...
const contactMarkup = `
<section class="fp-section"><div class="page-width"><div class="fp-heading"><div><p class="fp-kicker">Contact channels</p><h2>How can we help?</h2></div><p>Select the contact area that best matches your request. Phone numbers and email details remain available directly on this standalone page.</p></div><div class="fp-contact-grid"><article class="fp-contact-card"><h3>FLOTA Program</h3><a href="tel:+447378347853">+44 7378347853</a><span>For mobile phones</span><a href="mailto:info@orlenenergies.com">info@orlenenergies.com</a></article><article class="fp-contact-card"><h3>Website and data</h3><a href="mailto:info@orlenenergies.com">info@orlenenergies.com</a><span>Website issues</span><strong>Andrzej Kamiński</strong><span>Data Protection Officer</span></article></div></div></section>
